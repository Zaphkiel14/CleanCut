    ...
    <div class="row justify-content-center">
        <div class="col-md-8 col-lg-6">
            <div class="card shadow-lg">
                ...
                <!-- Start of Community Footer Addition -->
                <div class="card-footer bg-light text-center mt-3 border-0">
                    <span>Want to join our community as a</span>
                    <b>Barber</b>
                    <span>or</span>
                    <span><b>Shop Owner</b></span>
                    <span>?  <a href="<?= base_url('subscriptions') ?>" class="fw-bold text-primary ms-1">See our Subscription Plans.</a> <i class="fas fa-arrow-right"></i></span>
                </div>
                <!-- End of Community Footer Addition -->
            </div>
        </div>
    </div>
</div>
